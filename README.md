...
I'm the creator of [**Silver Cam**](https://silver-cam.com/en), a full-featured e-commerce platform, and I actively work with **Supabase** for authentication, email workflows, edge functions, and data-driven backends. My current technical focus is on integrating AI responsibly, minimizing cloud dependency, and exploring **on-device / local LLM approaches**.
